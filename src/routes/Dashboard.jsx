...
async function SignOut() {
  ...
  $('.modal-backdrop').remove(); //elimina el fondo del modal
  return redirect('/Login');
}
        ...
        >
          ...
          <ul className="nav nav-pills flex-column mb-auto">
            <li className="nav-item">
              <NavLink to={"/users"} className="nav-link link-dark" aria-current="page">
            ...
            <li className="nav-item">
              <NavLink to={"/CreateUser"} className="nav-link link-dark" aria-current="page">
                <svg className="bi pe-none me-2" width={16} height={16}>
                  <use xlinkHref="#home" />
                </svg>
                Crear Usuario
          ...
          <div className="dropdown">
            ...
            >
              <img
                src={Route()+'img/'+(dataLogin.photo_user  == null ? "noneImg.png": dataLogin.photo_user )}
                alt=""
                width={32}
                height={32}
                className="rounded-circle me-2"
              />
              <strong>{dataLogin.name_user}</strong>
            </a>
